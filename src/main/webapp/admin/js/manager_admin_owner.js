document.addEventListener('DOMContentLoaded', function () {
    ...
    const updateButtons = document.querySelectorAll('.auth-btn');
    ...
    let deleteModal = document.getElementById('delete-modal'); // Modal xóa cập nhật
    let confirmDeleteButton = document.getElementById('confirm-delete'); // Nút xác nhận cập nhật
    document.querySelectorAll('.auth-btn').forEach(function(button) {
        button.addEventListener('click', function(e) {
            ...
            const url = `role-account?id=${userId}`; // Đường dẫn xóa tài khoản kèm ID
