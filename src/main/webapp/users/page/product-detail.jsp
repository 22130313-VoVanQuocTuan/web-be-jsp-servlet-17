...
<div id="section-content-1">
    <div class="product-details">
        ...
        <div class="product-info">
            ...
            <p class="product-price">Giá: <strong><fmt:formatNumber value="${product.discountPrice}" type="number"
        ...
        <div class="review-section">
            ...
            <c:forEach var="rating" items="${ratings}">
                <div class="review-item">
                    <p><strong>Người dùng:</strong> ${rating.username}</p>
                    <p><strong>Ngày đánh giá:</strong> <fmt:formatDate value="${rating.createdAt}"
                                                                       pattern="dd/MM/yyyy"/></p>
                    <p><strong>Nội dung:</strong> ${rating.content}</p>
                    <hr>
                </div>
            </c:forEach>
        </div>
