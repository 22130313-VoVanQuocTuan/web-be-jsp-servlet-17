                ...
                <ul class="nav navbar-nav navbar-center">
                    <li class="propClone">
                        ...
                        <ul class="items">
                            ...
                            <li><a href="./xi-mang-va-vua.html">&nbsp;&nbsp;<i
    ...
    <div class="conten">
        <div class="left-sidebar">
            ...
            <div class="item" data-category="xi-mang-va-vua">
                <h3><a href="xi-mang-va-vua.html">Xi măng và Vữa</a></h3>
            </div>
        ...
        <div class="right">
            ...
            <div class="row ps-5" id="product-list">
                <!-- Sản phẩm 1 đến 18 -->
                <div class="name-cart">
                    <a href="../product-detail.jsp"><img src="/src/Users/img_product/xingmang/image1.png"
                                                         alt="Xi măng"></a>
                ...
                <div class="name-cart">
                    <a href="../product-detail.jsp"><img src="/src/Users/img_product/xingmang/image2.png"
                                                         alt="Xi măng"></a>
                ...
                <div class="name-cart">
                    <a href="../product-detail.jsp"><img src="/src/Users/img_product/xingmang/ximagfico.png"
                                                         alt="Xi măng"></a>
                ...
                <div class="name-cart">
                    <a href="../product-detail.jsp"><img src="/src/Users/img_product/xingmang/ximamg allybuild.png"
                                                         alt="Xi măng"></a>
                ...
                <!-- Sản phẩm 1 đến 18 -->
                <div class="name-cart">
                    <a href="../product-detail.jsp"><img src="/src/Users/img_product/xingmang/ximamgholikem.png"
                                                         alt="Xi măng"></a>
