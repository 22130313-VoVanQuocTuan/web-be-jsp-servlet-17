                    ...
                    <li class="propClone">
                        ...
                        <ul class="items">
                            ...
                            <li><a href="thep-va-sat.jsp">&nbsp;&nbsp;<i
                                    ...
                                    SẮT</a></li>
                            <li><a href="./go-va-vat-lieu-go.html">&nbsp;&nbsp;<i
    ...
    <div class="conten">
        <div class="left-sidebar">
            ...
            <div class="item" data-category="go-va-vat-lieu-go">
                <h3><a href="go-va-vat-lieu-go.html">Gỗ và Vật liệu gỗ</a></h3>
            </div>
        ...
        <div class="right">
            ...
            <div class="row ps-5" id="product-list">
                <!-- Sản phẩm 1 đến 18 -->
                <div class="name-cart">
                    <a href="../product-detail.jsp"><img src="/src/Users/img_product/vat_lieu_go/image1.png"
                                                         alt="Xi măng"></a>
                    <h3>Gỗ cao cấp</h3>
                ...
                <div class="name-cart">
                    <a href="../product-detail.jsp"><img src="/src/Users/img_product/vat_lieu_go/image10.png"
                                                         alt="Xi măng"></a>
                    <h3>Gỗ trắng đặc</h3>
                    <p>Giá: <del>200.000₫</del></p>
                    <p style="color: red;">Giá đã giảm: 190.000₫</p>
                ...
                <div class="name-cart">
                    <a href="../product-detail.jsp"><img src="/src/Users/img_product/vat_lieu_go/image12.png"
                                                         alt="Xi măng"></a>
                    <h3>Gỗ đa năng</h3>
                    <p>Giá: <del>200.000₫</del></p>
                    <p style="color: red;">Giá đã giảm: 190.000₫</p>
                ...
                <div class="name-cart">
                    <a href="../product-detail.jsp"><img src="/src/Users/img_product/vat_lieu_go/image2.png"
                                                         alt="Xi măng"></a>
                    <h3>Gỗ thanh trà</h3>
                    <p>Giá: <del>200.000₫</del></p>
                    <p style="color: red;">Giá đã giảm: 190.000₫</p>
                ...
                <!-- Sản phẩm 1 đến 18 -->
                <div class="name-cart">
                    <a href="../product-detail.jsp"><img src="/src/Users/img_product/vat_lieu_go/image3.png"
                                                         alt="Xi măng"></a>
                    <h3>Gỗ lõi đen </h3>
                    <p>Giá: <del>200.000₫</del></p>
                    <p style="color: red;">Giá đã giảm: 190.000₫</p>
